                ...
                <div className="w-full max-w-[420px]">
                    <div className="glass-card rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-4 py-2.5 h-11 bg-stone-900/50 border-stone-800 text-stone-100 placeholder:text-stone-600 rounded-lg focus-visible:border-blue-500 focus-visible:ring-blue-500/20 transition-all duration-150 w-full"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-10 py-2.5 h-11 bg-stone-900/50 border-stone-800 text-stone-100 placeholder:text-stone-600 rounded-lg focus-visible:border-blue-500 focus-visible:ring-blue-500/20 transition-all duration-150 w-full"
                                    />
                                    <button
                                        type="button"
                        ...
                        <div className="relative my-6 flex items-center justify-center">
                            <div className="absolute inset-x-0 h-px bg-stone-800/80"></div>
                            <span className="relative px-3 bg-[#0d0d12] rounded-md text-xs font-medium text-stone-500 uppercase tracking-wider">or continue with</span>
                        </div>

                        {/* OAuth Buttons */}
                        <div className="grid grid-cols-2 gap-3">
                            <button type="button" className="flex items-center justify-center gap-2.5 py-2.5 px-4 rounded-lg bg-stone-900/60 hover:bg-stone-800 border border-stone-800 text-stone-200 text-sm font-medium transition-colors cursor-pointer">
