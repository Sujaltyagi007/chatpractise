                ...
                <div className="w-full max-w-[420px]">
                    <div className="glass-card rounded-2xl p-5 sm:p-6 space-y-4 shadow-2xl">
                        ...
                        <div className="relative my-3.5 flex items-center justify-center">
                            ...
                            <span className="relative px-3 bg-[#0d0d12] rounded-md text-[10px] font-medium text-stone-500 uppercase tracking-wider">or sign up with</span>
                        </div>

                        {/* OAuth Buttons */}
                        <div className="grid grid-cols-2 gap-3">
                            <button type="button" className="flex items-center justify-center gap-2 py-2 px-3 rounded-lg bg-stone-900/60 hover:bg-stone-800 border border-stone-800 text-stone-200 text-sm font-medium transition-colors cursor-pointer">
