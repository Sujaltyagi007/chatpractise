...
import {
  Search, Plus, Settings, LogOut, User, MessageSquare, Archive,
} from "lucide-react";
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              render={
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-zinc-500 hover:text-zinc-950 dark:hover:text-white shrink-0"
            ...
            >
              <DropdownMenuItem
                ...
                className="text-sm p-2 text-zinc-700 dark:text-zinc-300 gap-2 cursor-pointer"
              >
            ...
            {filtered.length === 0 ? (
              searchQuery ? (
                <div className="flex flex-col items-center justify-center py-10 text-zinc-400">
                  <Search className="h-6 w-6 text-zinc-300 mb-2" />
                ...
                >
                  <div className="relative shrink-0">
                    <Avatar className="h-9 w-9">
                      ...
                      <AvatarFallback className="bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-xs font-semibold">
