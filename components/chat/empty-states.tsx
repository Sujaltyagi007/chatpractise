  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 select-none">
      <div className="relative mb-5">
        ...
        <span className="absolute -bottom-1 -right-1 h-7 w-7 rounded-full bg-white dark:bg-zinc-900 border-2 border-indigo-200 dark:border-indigo-800 flex items-center justify-center">
      ...
      <p className="text-xs text-zinc-400 text-center max-w-[160px] mb-4">
...
export function NoMessagesEmptyState({ name }: { name: string }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4 text-zinc-400 select-none">
      ...
      <p className="text-xs text-zinc-400 mt-1.5 text-center max-w-xs">
...
export function NoUsersFoundEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4 select-none">
      ...
      <p className="text-xs text-zinc-400 mt-1 text-center max-w-[180px]">
